        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
          <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
            <h1 className="title-font font-medium text-3xl text-gray-900">
              Login to experience the best services tailored for you.
            </h1>
            <p className="leading-relaxed mt-4">
              Join our community and stay connected with the latest trends and updates.
            </p>
            <p className="leading-relaxed mt-4">
                Stay connected with us to get most updated version of this application
            </p>
          </div>
          <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
          <div className="flex flex-col justify-center items-center ">
            <h2 className="text-gray-900 text-4xl  title-font mb-5 font-serif font-[530] ">Login</h2>
          </div>
            <form
              ref={ref}
            ...
            <p className="text-xs text-gray-500 mt-5 mb-10">
              Do not have an account?{" "}
              <Link className="text-indigo-500" href="/users/signup">
                Signup
              </Link>
            </p>
          </div>
